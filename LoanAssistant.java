...
private void computeButtonActionPerformed1(ActionEvent e)
{
double balance, interest, payment;
int months;
double monthlyInterest, multiplier;
...
response = JOptionPane.showConfirmDialog(null, "This is an example of an confirm dialog box.", "Example", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE);
...
private void computeButtonActionPerformed11(ActionEvent e)
{
double balance, interest, payment;
int months;
double monthlyInterest, multiplier;
...
private void computeButtonActionPerformed111(ActionEvent e)
{
double balance, interest, payment;
int months;
double monthlyInterest, multiplier;
